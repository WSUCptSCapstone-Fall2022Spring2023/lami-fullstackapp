  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      home: Scaffold(
          ...
          body: EditMedicationForm(key: key, medication: medication)),
    );
  }
}
...
class EditMedicationFormState extends State<EditMedicationForm> {
  ...
  late String id = widget.medication.id;
  late RepeatOption repeatOption = widget.medication.repeatOption;
  late List<bool> repeatDays = widget.medication.daysOfWeek;
  late int timesPerDay = widget.medication.repeatTimes;
  late List<Alarm> alarms = widget.medication.alarms;

  // will have to change in the future - depends on type used to get time
  //final timeController = TextEditingController();
  @override
  Widget build(BuildContext context) {
    medicationController.text = widget.medication.nameOfDrug;
